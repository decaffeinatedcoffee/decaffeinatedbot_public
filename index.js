...
const client = new Discord.Client({ intents: ["GUILDS","GUILD_MESSAGES", "GUILD_MESSAGE_REACTIONS", "DIRECT_MESSAGES", "DIRECT_MESSAGE_TYPING", "GUILD_VOICE_STATES","GUILD_PRESENCES"], partials: ["CHANNEL" , "SEND_TTS_MESSAGES"]});
...
var nomekick = "<@" + membrokick + ">";
 ...
 catch{ msg.reply("I cant kick this user, probably their role is higher than mine, sorry );");
}
}
    }
}
...
if(msg.member.permissions.has(["MANAGE_ROLES", "BAN_MEMBERS"])){
  ...
  catch{ msg.reply("I cant ban this user, probably their role is higher than mine, sorry );");
}
}
...
if(motivo == ""){
  ...
  catch{ msg.reply("I cant mute this user, probably their role is higher than mine, sorry );");
}
}
...
if(motivo == ""){
  ...
  catch{ msg.reply("I cant unmute this user, probably their role is higher than mine, sorry );");
}
}
else{
...
if(msg.member.permissions.has(["MANAGE_ROLES", "BAN_MEMBERS"])){
  ...
  catch{ msg.reply("I cant warn this user, probably their role is higher than mine, sorry );");
}
}
}
else{
